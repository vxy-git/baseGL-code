...
const unitData = computed(() => {
  if (props.data) {
    return { ...product1Unit4Data, ...props.data };
  }
  return product1Unit4Data;
});
...
<template>
  <div class="mt-[507px] m_mt_0">
    ...
    <div class="c_1230 c_padding mt-[185px]">
      <div class="greenText">{{ unitData.section1.greenText }}</div>
      <div class="flex justify-between mt-[19px] gap-[20px] m_flex_col">
        <div class="title2">
          {{ unitData.section1.title }}
        </div>
        <div class="label">
          {{ unitData.section1.description }}
        </div>
      </div>
    ...
    <div class="c_1230 c_padding mt-[228px]">
      <div class="greenText">{{ unitData.section2.greenText }}</div>
      <div class="flex justify-between mt-[19px] gap-[20px] m_flex_col">
        <div class="title2">
          {{ unitData.section2.title }}
        </div>
        <div class="label mt-[2px]">
          {{ unitData.section2.description }}
        </div>
      </div>

...
<template>
  <div class="relative h-screen flex justify-center items-start pt-[373px]">
    <img :src="icon2_1" alt="" class="w-[400px] h-[680px] object-contain -mt-[152px] -translate-x-[200px]" />

    <div class="content-wrapper -mt-[152px] translate-x-[70px]">
      <div class="title1">
        100% Rosin-Ready
      </div>
      ...
      <div class="title3">
        ...
        Our patented U-shape ceramic design is the result of extensive testing and validation<br> of various structures. It is the optimal structure for the vast majority of Resin and Rosin oils on the market.<br>
        It is 30% thinner than ordinary ceramics while maintaining the strength, which means<br> fewer terpene molecules are filtered out, and the rich, natural flavors are preserved.
      </div>

      <div class="flex justify-center gap-x-[150px] mt-[18px]">
        ...
        <img src="@/assets/img/icon2_2.png" class="w-[763px] h-[368px] mt-[32px] translate-x-[-11px]">
    </div>

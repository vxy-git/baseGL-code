...
<template>
  <div class="max-w-[1702px] c_padding mx-auto pt-[156px]">
    <div class="w-full relative flex justify-between">
      <div class="content-wrapper mt-[145px] pr-[110px] ml-[10.4vw] border-r-[1px] border-white/20">
        <div ref="contentRef1" class="flex flex-col items-center">
          <div class="title1">
            Built-in wires
          </div>
        ...
        <div ref="contentRef2" class="flex flex-col items-center">
      ...
      <MediaAsset :src="icon5_2" type="image" alt="" class="object-contain w-[577px] h-[560px] mt-[90px]" />
    </div>
  </div>

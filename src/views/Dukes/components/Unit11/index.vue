<script setup>
import { unit11Data } from '@/data/dukes/unit11.js'
...
const unitData = useUnitData(props, unit11Data)
</script>
  ...
  <div class="c_1230 c_padding mx-auto pt-[136px] pb-[162px]">
    ...
    <div class="relative mt-[58px] flex justify-start gap-[40px] m_flex_col_r">
      <div class="shrink-0 grid grid-cols-2 min-w-max gap-y-[15px] gap-x-[20px] w-[460px]">
        <div
          v-for="item in unitData.deviceSpecs.dukes"
          :key="item.label"
    ...
    <div class="relative mt-[127px] flex justify-end gap-[40px] m_flex_col">
      ...
      >
        <div
          v-for="item in unitData.deviceSpecs.dukesPro"
          :key="item.label"
          class="item flex flex-col items-center justify-center"
        >
          <div class="label">

...
import { unit2Data } from '@/data/why_caleaf/unit2'
...
<template>
  <section class="why-caleaf-facts">
...
.facts-container {
  ...
  width: 100%;
  padding: 88px 0 0; // 990 - 222 (hero top) - 680 (hero height) = 88
}
...
.facts-title {
  ...
  color: #000000;
  text-align: center;
  margin-bottom: 82px; // 1119 - 1037 (title bottom) = 82
}

    ...
    <div class=" relative c_1300 w-full c_padding mt-[51px] flex justify-center items-center">
      <div class="unitBox w-[1300px] h-[732px] shrink-0">
        ...
        <div class="z-[3] absolute top-0 left-0 w-[359px] h-[485px] rounded-[20px] overflow-hidden">
          <MediaAsset class="mediaAsset size-full object-cover rounded-[20px]" type="video" :src="mouthpieceVideo" autoplay muted
        ...
        <div class="z-[1] absolute top-0 left-[369px] w-[564px] h-[485px] rounded-[20px] overflow-hidden">
          <MediaAsset class="mediaAsset size-full object-cover rounded-[20px]" type="video" :src="functionInterfaceVideo" autoplay
        ...
        <div class="z-[1] absolute top-0 left-[943px] w-[355px] h-[237px] rounded-[20px] overflow-hidden">
          <MediaAsset class="mediaAsset size-full object-cover rounded-[20px]" type="video" :src="buttonVideo" autoplay muted loop
        ...
        <div class="z-[3] absolute top-[247px] left-[943px] w-[355px] h-[237px] rounded-[20px] overflow-hidden">
          <MediaAsset class="mediaAsset size-full object-cover rounded-[20px]" type="video" :src="stickerVideo" autoplay muted loop
        ...
        <div class="z-[1] absolute top-[495px] left-0 w-[643px] h-[238px] rounded-[20px] overflow-hidden">
          <MediaAsset class="mediaAsset size-full object-cover rounded-[20px]" type="video" :src="oilWindowVideo" autoplay muted loop
        ...
        <div class="z-[3] absolute top-[495px] left-[653px] w-[643px] h-[238px] rounded-[20px] overflow-hidden">
          <MediaAsset class="mediaAsset size-full object-cover rounded-[20px]" type="video" :src="housingVideo" autoplay muted loop

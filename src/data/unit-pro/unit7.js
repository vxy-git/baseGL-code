...
export const unit7Data = {
  ...
  oneButtonControl: {
    ...
    video: '/api/uploads/file/default/assets/unit_pro/one-R.mp4',
    steps: [
      {
        icon: '/api/uploads/file/default/assets/unit_pro/one-taps1.png',
        title: '1 Tap',
        label: 'Check temp',
      },
      {
        icon: '/api/uploads/file/default/assets/unit_pro/one-taps2.png',
        title: '2 Taps',
        label: 'Warm up',
      },
      {
        icon: '/api/uploads/file/default/assets/unit_pro/one-taps3.png',
        title: '3 Taps',
        label: 'Change temp',
      },
      {
        icon: '/api/uploads/file/default/assets/unit_pro/one-taps4.png',
        title: '5 Taps',
        label: 'Turn on/off',
      },
    ],

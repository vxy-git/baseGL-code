 ...
 * 背景图片路径
 */
export const BG_IMAGE = '/assets/technology/b2.png'

/**
 * 标题文本
 */
export const TITLE_TEXT = 'From lab to awards: journey to the top'

/**
 * 描述文本
 */
export const DESCRIPTION_TEXT = `Our R&D Director, Frank, with 20 years of industry experience, has worked with US labs for 18 months,
